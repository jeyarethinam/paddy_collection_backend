...
exports.pass_reset = function(data) {
    return '<!DOCTYPE html>\n' +
        '<html lang="en">\n' +
        '<head>\n' +
        '    <meta charset="UTF-8">\n' +
        ...
        '                        <u>Leave Management System - Unicom SD</u> <br>\n' +
        '                    </td>\n' +
        '                </tr>\n' +
        '\n' +
        '                <tr>\n' +
        ...
        '                        You requested for your password to be reset by <b> ' + data.email + ' </b> of email so your password has been reset and a new password\n' +
        '                        has been sent to you from Leave Management System of Unicom SD.\n' +
        '                    </td>\n' +
        '                </tr>\n' +
        '\n' +
        '                <tr>\n' +
        '                    <td style="padding-top: 20px;color: #9095a2; font-size: 16px; font-weight: 400; "> New Password: ' + data.password + ' </td>\n' +
        '                </tr>\n' +
        '\n' +
        '                <tr>\n' +
